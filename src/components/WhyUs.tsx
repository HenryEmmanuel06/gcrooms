    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto w-[90%] max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px]">
          {/* Card 1: Super Fast */}
          <div className="rounded-[15px] w-[100%] h-[310px] p-8 relative overflow-hidden border-3 border-[#fff]" style={{
            ...
            {/* Card Image */}
            <div className="absolute bottom-[20px] right-[15px] w-[137px] h-[109px] rounded-[10px] overflow-hidden">
              <Image
