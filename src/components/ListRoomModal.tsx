                  ...
                  <div className="grid grid-cols-1 md:grid-cols-10 gap-4 flex-1">
                    ...
                    <div className="md:col-span-10 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <input
                          ...
                          className={`w-full px-3 py-5 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[20px] ${validationErrors.property_title ? 'border-red-500' : 'border-gray-300'
                            }`}
                    ...
                    <div className="md:col-span-1">
                      <input
                        ...
                        className={`w-full px-1 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[14px] ${validationErrors.house_no ? 'border-red-500' : 'border-gray-300'
                          }`}
                        placeholder="No:"
                        pattern="[0-9]+"
                      />
                    ...
                    <div className="relative md:col-span-4">
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[14px] ${validationErrors.location ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div className="relative md:col-span-2 z-20">
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-gray-500 text-[14px] ${validationErrors.state ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div className="md:col-span-7">
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[14px] ${validationErrors.price ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div className="md:col-span-3">
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-gray-500 text-[14px] ${validationErrors.duration ? 'border-red-500' : 'border-gray-300'
                          }`}
                      >
                    ...
                    <div className="md:col-span-3">
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[14px] ${validationErrors.bedrooms ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div className="md:col-span-2">
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-full focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[14px] ${validationErrors.bathrooms ? 'border-red-500' : 'border-gray-300'
                          }`}
                    ...
                    <div className="relative md:col-span-5">
                      <button
                        ...
                        className={`w-full h-[42px] px-3 py-2 border rounded-full text-left focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent text-black flex items-center overflow-x-auto overflow-y-hidden ${validationErrors.furnishing ? 'border-red-500' : 'border-gray-300'
                    ...
                    <div className="md:col-span-10">
                      <textarea
                        ...
                        rows={4}
                        className={`w-full px-3 py-2 border rounded-xl focus:ring-2 focus:ring-[#10D1C1] focus:border-transparent placeholder-gray-500 text-black text-[14px] ${validationErrors.description ? 'border-red-500' : 'border-gray-300'
                          }`}
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed mb-6">
                      ...
                      Please check your email — we&apos;ve sent you details on your room review. We&apos;ll notify you once it&apos;s approved and share guest info when booked. Your first booking enjoys 10% commission (standard 14%). Your privacy is always protected.
                    </p>
