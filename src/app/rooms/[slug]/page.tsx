        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[50px]">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-white rounded-2xl p-6 py-2 px-0">
              ...
              <div className="flex items-center text-black mb-[20px] gap-[10px] border-[0.5px] border-[#00000033] px-[20px] py-[10px] rounded-full max-w-[600px]">
                <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 7.58337C6.9665 7.58337 7.75 6.79987 7.75 5.83337C7.75 4.86688 6.9665 4.08337 6 4.08337C5.0335 4.08337 4.25 4.86688 4.25 5.83337C4.25 6.79987 5.0335 7.58337 6 7.58337Z" stroke="#111111" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M6.00004 1.16669C4.76236 1.16669 3.57538 1.65835 2.70021 2.53352C1.82504 3.40869 1.33337 4.59568 1.33337 5.83335C1.33337 6.93702 1.56787 7.65919 2.20837 8.45835L6.00004 12.8334L9.79171 8.45835C10.4322 7.65919 10.6667 6.93702 10.6667 5.83335C10.6667 4.59568 10.175 3.40869 9.29987 2.53352C8.4247 1.65835 7.23772 1.16669 6.00004 1.16669Z" stroke="#111111" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ...
            <div className="bg-white pt-[20px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 shadow-[0px_1px_25px_0px_#0000001A,0px_0px_3px_0px_#00000012] rounded-[15px] bg-[#F5D4FF] px-[35px] py-[30px]">
                ...
                <div className="pl-[25] pr-[10px] p-3 flex items-center gap-2 border-x border-[#00000033]">
                ...
                <div className="p-3 pl-[25px] rounded-lg flex items-center gap-2">
            ...
            {/* Description */}
            <div className="p-6 pl-0 mt-[10px]">
              <h2 className="text-[24px] font-semibold text-black tracking-wide mb-[10px]">Description</h2>
              <p className="text-[16px] text-black tracking-wide">
            ...
            <div className="p-6 pl-0 pt-0">
              <h2 className="text-[24px] font-semibold text-black tracking-wide mb-[10px]">About Me</h2>
              <p className="text-[16px] text-black tracking-wide">
            ...
            <div className='mt-[10px]'>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#10D1C10D] border-2 border-[#10D1C1] rounded-2xl p-6 pb-10 h-full">
                  <h3 className="text-[24px] font-semibold text-black tracking-wide mb-[10px]">Likes</h3>
                  <p className="text-[16px] text-black tracking-wide">
                ...
                <div className="bg-[#FF2C790D] border-2 border-[#FF2C79] rounded-2xl p-6 pb-10 h-full">
                  <h3 className="text-[24px] font-semibold text-black tracking-wide mb-[10px]">Dislikes</h3>
                  <p className="text-[16px] text-black tracking-wide">
            ...
            {/* Property Location */}
            <div className="mt-[40px]">
              <h2 className="text-[24px] font-semibold text-black tracking-wide mb-[20px]">Property Location</h2>
